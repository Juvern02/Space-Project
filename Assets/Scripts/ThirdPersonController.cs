...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void GroundedCheck()
        {
            ...
            // Vector3 rayStart = transform.position + Vector3.up * 0.1f; // adjust the offset based on your character size

            // Grounded = Physics.Raycast(rayStart, Vector3.down, out hit, GroundedOffset + 0.1f, GroundLayers, QueryTriggerInteraction.Ignore);
